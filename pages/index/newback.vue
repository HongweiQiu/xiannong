<template>
	<view>
		<uni-nav-bar left-icon="arrowleft"  title="新品反馈"
		:status-bar="navBar" fixed="true" @clickLeft="leftClick" @clickRight="rightClick"></uni-nav-bar>
			...
			<view class="xp-sc">
				<block v-for="(item, index) in img" v-if="img != ''">
...
let { appid,navBar,appsecret, rootUrl, imgUrl } = app;
export default {
	data() {
		return {
			imgUrl: app.imgUrl,
