...
var _receipt = _interopRequireDefault(__webpack_require__(/*! ./pages/user/receipt.vue */ 196));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _receipt_vue_vue_type_template_id_593cca26___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./receipt.vue?vue&type=template&id=593cca26& */ 197);
/* harmony import */ var _receipt_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./receipt.vue?vue&type=script&lang=js& */ 199);
...
/* harmony import */ var _receipt_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./receipt.vue?vue&type=style&index=0&lang=css& */ 201);
...
var _default =
{
  ...
  methods: {
    formSubmit: function formSubmit() {var _this = this;var

      tax_name =
      this.tax_name,tax_num = this.tax_num;
      ...
      this.$get(this.$api.orderSex_tax, params, function (res) {
        if (res.data.code == 1) {
          _this.$Toast('修改成功');
          setTimeout(function () {
            uni.navigateBack();
    ...
    getUserInfo: function getUserInfo() {var _this2 = this;
      ...
      this.$get(this.$api.userInfo, params, function (res) {var
        ...
        res.data;
        if (data.code == 1) {
          _this2.tax_name = data.data.tax_name;
          _this2.tax_num = data.data.tax_num;
        }
      });
    } },
